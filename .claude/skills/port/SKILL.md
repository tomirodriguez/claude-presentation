...
export type UserRepository = {
   ...
   */
  findAll: (ctx: OrganizationContext, filters?: UserListFilters, pagination?: Pagination) => ResultAsync<User[], RepositoryError>

  /**
   * Count all non-deleted users
   */
  count: (ctx: OrganizationContext) => ResultAsync<number, RepositoryError>
...
- [ ] Define `{Entity}ListFilters` type if listing is needed
